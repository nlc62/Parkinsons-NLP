...
if __name__ == '__main__':
    ...
    d1, _ = dataset.get_only_n_texts_per_class(100)
    
    #Extract text for VADER
    sentences = d1.get_all_strings()

    #Extract ground truth labels
    ground_truth_list = d1.get_all_labels()
    ...
    confusion_matrix = [[pos_precision, pos_recall, pos_f1, pos_count],
                        [neutral_precision, neutral_recall, neutral_f1, neutral_count],
                        [neg_precision, neg_recall, neg_f1, neg_count],
                        [weighted_average_precision, weighted_average_recall, weighted_average_f1, 'N/A']
                        ]
    
    print(tabulate([['pos', pos_precision, pos_recall, pos_f1, 'N/A', pos_count],
                    ['neutral', neutral_precision, neutral_recall, neutral_f1, 'N/A', neutral_count],
                    ['neg', neg_precision, neg_recall, neg_f1, 'N/A', neg_count],
                    ['w_avg', weighted_average_precision, weighted_average_recall, weighted_average_f1, accuracy, weighted_average_count]
